                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                ...
                                <TextEffect
                                    ...
                                    className="mx-auto mt-8 max-w-2xl text-balance text-lg">
                                     TailFlow organizes converesations into channels with threads, is realtime and uses AI to keep teams sync.  
                                </TextEffect>
                        ...
                        <AnimatedGroup
                            ...
                            <div className="mask-b-from-55% relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                                    <Image
                                        className="bg-background aspect-15/8 relative hidden rounded-2xl object-contain objec dark:block"
                                        src={HeroDark}
                                        alt="app screen"
                                        width="2700"
                                        height="1440"
                                    />
                                    <Image
                                        className="z-2 border-border/25 aspect-15/8 relative rounded-2xl object-contain objec border dark:hidden"
                                        src={HeroLight}
                                        alt="app screen"
                                        width="2700"
                                        height="1440"
                ...
                <section className="bg-background pb-16 pt-16 md:pb-32">
                    <div className="group relative m-auto max-w-5xl px-6">
                        ...
                        <div className="group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
                            ...
                            <div className="flex">
                                <Image
                                    className="mx-auto h-7 object-contain light:invert dark:invert-0"
                                    src={NeonLogo}
                                    alt="Neon Logo"
                                />
                            </div>
